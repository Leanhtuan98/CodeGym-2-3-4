        ...
        <div class="page-title">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              ...
              <li><a href="#" style="font-weight: bold">User</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="table-responsive mb-4">
          <table id="customer-info-detail-3" class="table style-3 table-bordered  table-hover">
            ...
            <c:forEach items="${users}" var="u">
              <tr>
                <td class="text-center"><c:out value="${u.getId()}"/></td>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          <label>Tel</label>
                          <input type="text" class="form-control"
                                 value="${u.getPhoneNumber()}$" readonly>
                        </div>
                        <div class="form-group">
                          <label>Email</label>
                          <input type="text" class="form-control"
                ...
                <div id="e${u.getId()}" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
<%--                      <form action="${pageContext.request.contextPath}/user?action=updateByAdmin"--%>
                      <form action="#"
                            method="post" id="formEdit${u.getId()}">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="role">
                              <c:if test="${u.getRole().equals('user')}">
                                <option value="user">User</option>
                                <option value="admin">Admin</option>
                              </c:if>
                              <c:if test="${u.getRole().equals('admin')}">
                                <option value="admin">Admin</option>
                                <option value="user">User</option>
                              </c:if>
                            </select>
                        ...
                        <div class="modal-footer">
                          <input type="button" class="btn btn-default" data-dismiss="modal"
                                 value="Cancel">
                          <input type="submit" class="btn btn-success" value="Save" id="edit${u.getId()}">
                        </div>
                      </form>
                    </div>
                  </div>
              ...
              <script>
                document.querySelector('#edit${u.getId()}').addEventListener('click', (event) => {
                  ...
                  Swal.fire({
                    ...
                    document.querySelector('#formEdit${u.getId()}').submit();
                  })
                })
              </script>
            </c:forEach>
...
<div id="addProductModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
<%--      <form action="${pageContext.request.contextPath}/user?action=registerByAdmin" method="post" id="formCreate">--%>
